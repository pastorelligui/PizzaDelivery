...
public class FuncionarioGUI extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        LB_Permissao = new javax.swing.JLabel();
        ...
        LB_Cargo.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        CB_Cargo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione um Cargo", "Atendente", "Pizzaiolo", "Gerente" }));
        ...
        LB_Permissao.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        LB_Permissao.setText("Permissão:");

        CB_Permissao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione uma Permiissão", "AT", "PZ", "SUPER" }));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(LB_Permissao)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(CB_Permissao, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void TF_PesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TF_PesquisarKeyReleased
        Modelo.setNumRows(0);
        FuncionarioC.controlePesquisa(TF_Pesquisar.getText(), Modelo);
    ...
    private void TabelaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaMousePressed
       ...
       TF_Codigo.setText(FuncionarioB.getCodigo() + "");
       TF_Nome.setText(FuncionarioB.getNome());
       CB_Cargo.setSelectedItem(FuncionarioB.getCargo());
       CB_Permissao.setSelectedItem(FuncionarioB.getPermissao());
      TF_Data.setText(FuncionarioB.getDataCad()); 
    ...
    private void B_NovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B_NovoActionPerformed
        ...
        TF_Codigo.setText(FuncionarioC.controleDeCodigo());
        limparNovo();
    }//GEN-LAST:event_B_NovoActionPerformed

    private void B_CadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B_CadastrarActionPerformed
        capturaBeans();
        if(FuncionarioC.verificaDados(FuncionarioB, CB_Cargo.getSelectedIndex(), CB_Permissao.getSelectedIndex())){
         limparTudo();
         habilitaTudo(false);
    ...
    private void B_EditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B_EditarActionPerformed
        capturaBeans();
         if(FuncionarioC.verificaDadosParaEditar(FuncionarioB, CB_Cargo.getSelectedIndex(), CB_Permissao.getSelectedIndex())){
         limparTudo();
         habilitaTudo(false); 
         }
    ...
    private javax.swing.JLabel LB_Permissao;
    ...
    final FuncionarioBeans capturaBeans(){  //obtem o FuncionarioBeans
        FuncionarioB.setCodigo(Integer.parseInt(TF_Codigo.getText()));
        FuncionarioB.setNome(TF_Nome.getText());
        FuncionarioB.setCargo(CB_Cargo.getSelectedItem().toString());
        FuncionarioB.setPermissao(CB_Permissao.getSelectedItem().toString());
        FuncionarioB.setDataCad(TF_Data.getText());
